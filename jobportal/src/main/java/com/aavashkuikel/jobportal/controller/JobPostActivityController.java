...
import com.aavashkuikel.jobportal.services.JobPostActivityService;
import com.aavashkuikel.jobportal.services.JobSeekerApplyService;
import com.aavashkuikel.jobportal.services.JobSeekerSaveService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model, @RequestParam(value = "job", required = false) String job,
        ...
        model.addAttribute("today", today);  // Boolean parameter
        model.addAttribute("days7", days7);  // Boolean parameter
        model.addAttribute("days30", days30);  // Boolean parameter
